        ...
        <table class="google-form-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.schedule.delete', $schedule->ScheduleID) }}"
                            class="btn btn-danger"
                            onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this schedule?')) { document.getElementById('delete-form-{{ $schedule->ScheduleID }}').submit(); }">
                            Delete
                         </a>
                    </td>
                </tr>
